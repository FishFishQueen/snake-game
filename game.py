...
class SNAKE:
    ...
    def draw_snake(self):
        ...
        for index,block in enumerate(self.body):
            ...
            #2 what direction is the facing heading
            if index == 0:
...
class MAIN_MENU:
    def __init__(self):
        self.state = 'Start'  # Initial option highlighted

    def draw_menu(self):
        screen.fill((175, 215, 70))
        # Title
        title_surface = game_font.render('Snake Game', True, (255, 255, 255))
        title_rect = title_surface.get_rect(center=(cell_size * cell_number / 2, cell_size * 5))
        screen.blit(title_surface, title_rect)

        # Start Game option
        start_color = (255, 255, 255) if self.state == 'Start' else (100, 100, 100)
        start_surface = game_font.render('Start Game', True, start_color)
        start_rect = start_surface.get_rect(center=(cell_size * cell_number / 2, cell_size * 10))
        screen.blit(start_surface, start_rect)

        # Quit Game option
        quit_color = (255, 255, 255) if self.state == 'Quit' else (100, 100, 100)
        quit_surface = game_font.render('Quit Game', True, quit_color)
        quit_rect = quit_surface.get_rect(center=(cell_size * cell_number / 2, cell_size * 12))
            ...
            for event in pygame.event.get():
                ...
                if event.type == pygame.KEYDOWN:
                    if event.key == pygame.K_UP or event.key == pygame.K_DOWN:
                        self.state = 'Quit' if self.state == 'Start' else 'Start'
    ...
    for event in pygame.event.get():
        ...
        if event.type == pygame.KEYDOWN:
            if event.key == pygame.K_UP:
                if main_game.snake.direction.y != 1:  # Prevent moving in the opposite direction
                    main_game.snake.direction = Vector2(0, -1)
            if event.key == pygame.K_DOWN:
                if main_game.snake.direction.y != -1:  # Prevent moving in the opposite direction
                    main_game.snake.direction = Vector2(0, 1)
            if event.key == pygame.K_RIGHT:
                if main_game.snake.direction.x != -1:  # Prevent moving in the opposite direction
